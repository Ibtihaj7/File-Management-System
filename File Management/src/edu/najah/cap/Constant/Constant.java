package edu.najah.cap.Constant;

public abstract class Constant {
  public static final String SMALL_SIZE_FILE="Small";
    public static final String MEDIUM_SIZE_FILE ="Medium";
    public static final String LARGE_SIZE_FILE ="Large";
  ...
  public static final String AUTHENTICATION_EXCEPTION_MESSAGE ="User name or password incorrect.";
